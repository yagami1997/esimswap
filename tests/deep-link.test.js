...
describe('generateDeepLink', () => {
  it('encodes LPA string into URL', () => {
    const url = generateDeepLink('LPA:1$carrier.example.com$ABC12-DEF34', 'https://esim.kyowarp.com');
    assert.ok(url.startsWith('https://esim.kyowarp.com/?lpa='));
  ...
  it('round-trips through parseDeepLink', () => {
    ...
    const url = generateDeepLink(lpa, 'https://esim.kyowarp.com');
